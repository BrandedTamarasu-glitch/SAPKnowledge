...
must_haves:
  truths:
    ...
    - "Item category determination 4-key logic documented: sales doc type + item category group (MVKE-MTPOS) + usage + higher-level item category → OVLP"
  ...
  key_links:
    ...
    - from: "modules/sd/config-spro.md item category determination"
      ...
      pattern: "MTPOS|item category group|OVLP"
---
